...
Public Class crGenerateATW
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KyowaSystem_Shippingline.crGenerateATW.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrGenerateATW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crGenerateATW = New crGenerateATW()
        rpt.Site = Me.Site
        Return rpt
    End Function
