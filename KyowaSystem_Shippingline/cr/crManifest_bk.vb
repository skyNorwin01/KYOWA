...
Public Class crManifest_bk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KyowaSystem_Shippingline.crManifest_bk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrManifest_bk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crManifest_bk = New crManifest_bk()
        rpt.Site = Me.Site
        Return rpt
    End Function
