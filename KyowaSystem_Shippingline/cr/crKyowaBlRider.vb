...
Public Class crKyowaBlRider
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KyowaSystem_Shippingline.crKyowaBlRider.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrKyowaBlRider
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crKyowaBlRider = New crKyowaBlRider()
        rpt.Site = Me.Site
        Return rpt
    End Function
