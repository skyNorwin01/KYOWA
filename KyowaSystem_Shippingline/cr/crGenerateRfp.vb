...
Public Class crGenerateRfp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KyowaSystem_Shippingline.crGenerateRfp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrGenerateRfp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crGenerateRfp = New crGenerateRfp()
        rpt.Site = Me.Site
        Return rpt
    End Function
