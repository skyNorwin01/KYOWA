...
Public Class CrCorrectionAdvice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KyowaSystem_Shippingline.CrCorrectionAdvice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrCorrectionAdvice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrCorrectionAdvice = New CrCorrectionAdvice()
        rpt.Site = Me.Site
        Return rpt
    End Function
