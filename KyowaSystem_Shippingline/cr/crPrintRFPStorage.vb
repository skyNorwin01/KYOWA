...
Public Class crPrintRFPStorage
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KyowaSystem_Shippingline.crPrintRFPStorage.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_countIs() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrPrintRFPStorage
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPrintRFPStorage = New crPrintRFPStorage()
        rpt.Site = Me.Site
        Return rpt
    End Function
